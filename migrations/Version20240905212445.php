 ...
 */
final class Version20240905212445 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attendee DROP t_shirt_size');
        $this->addSql('ALTER TABLE product DROP default_role');
    }
}
